# RCA-0013 — a gate nobody invokes is inert, and it reports nothing

| Field | Value |
|---|---|
| RCA id | `RCA-0013` |
| Incident | `INC-0013` |
| Origin | `event: inert-gate-2026-09-14` — the committed board snapshot does not carry #725 (see [`RCA-0014`](RCA-0014-stale-snapshot-no-trigger.md)) |
| Severity | `high` |
...
- `CA-0017` — extend the gate-coverage rule to the **newly delivered** case
...
`SUGGEST-0011` — **delivery is not coverage: an artifact that no gate invokes is
...
- Ledger: `INC-0013`, `RCA-0013`, `CA-0017`, `SUGGEST-0011`.

## Follow-up

The incident closes with `CA-0017` (#725). Until then this repository carries at
