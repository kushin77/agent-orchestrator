# RCA-0009 — a shared tmpfs filled to 100 %, and a 0-byte write passed as evidence

| Field | Value |
|---|---|
| RCA id | `RCA-0009` |
| Incident | `INC-0009` |
| Origin | `event: tmpfs-full-2026-09-14` — the ledger records an **event** origin because the committed board snapshot does not carry #729 (see [`RCA-0014`](RCA-0014-stale-snapshot-no-trigger.md)) |
| Severity | `high` |
...
- `CA-0013` — deliver the machine-checkable guard
  ...
  that line lands the artifact is delivered but inert (`RCA-0013`).

## Lessons

`SUGGEST-0007` — **an infra limit is not a limit until a gate measures it.**
...
- Ledger: `INC-0009`, `RCA-0009`, `CA-0013`, `SUGGEST-0007`.

## Follow-up

The incident closes with `CA-0013`, i.e. when #729 merges **and** the check is
