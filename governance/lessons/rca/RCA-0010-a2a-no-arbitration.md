# RCA-0010 — agent-to-agent dispatch with no arbiter

| Field | Value |
|---|---|
| RCA id | `RCA-0010` |
| Incident | `INC-0010` |
| Origin | `event: a2a-no-arbitration-2026-09-14` — the committed board snapshot does not carry #726 (see [`RCA-0014`](RCA-0014-stale-snapshot-no-trigger.md)) |
| Severity | `high` |
...
- `CA-0014` — give the agent-to-agent dispatch path a single arbitration rule:
...
`SUGGEST-0008` — **an agent-to-agent path without an arbiter is a broadcast, not
...
- Ledger: `INC-0010`, `RCA-0010`, `CA-0014`, `SUGGEST-0008`.

## Follow-up

The incident closes with `CA-0014` (#726). The `corrective-action-open` deviation
