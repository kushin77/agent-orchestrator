# RCA-0014 — a committed snapshot with no trigger, and consumers that cannot resolve
...
- `CA-0018` — refresh and trigger on the dispatch path (issue **#727**): make the
...
`SUGGEST-0012` — **a committed snapshot needs a trigger, or its freshness rule
...
- Ledger: `INC-0014`, `RCA-0014`, `CA-0018`, `SUGGEST-0012`; the earlier instance
  of the class is `INC-0005` / `CA-0007` / `SUGGEST-0002` (#170).

## Follow-up

The incident closes with `CA-0018` (#727). `INC-0005` and `SUGGEST-0002` stay open
