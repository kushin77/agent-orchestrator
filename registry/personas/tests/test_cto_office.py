...
# Moved to the shared canonical location when CEO/CFO/PMO office directories
# were added (lane-purebliss-org): one schema for every office, not a
# per-office copy. See registry/personas/offices/schema/office.schema.json's
# own description for the CFO charter.yaml delta this canonicalization does
# NOT (yet) cover.
SCHEMA_PATH = PERSONAS_ROOT / "offices" / "schema" / "office.schema.json"
