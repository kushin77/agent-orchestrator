...
Usage::
    ...
    python3 -m paperclip.adapters.secrets.cli validate [--view FILE]
    python3 -m paperclip.adapters.secrets.cli view
    python3 -m paperclip.adapters.secrets.cli catalog
    python3 -m paperclip.adapters.secrets.cli rotation
    python3 -m paperclip.adapters.secrets.cli orphans
    python3 -m paperclip.adapters.secrets.cli read --path GSM_PATH \\
...
def _repo_root() -> Path:
    """The repository root — ``paperclip/adapters/secrets/cli.py`` -> four up."""
