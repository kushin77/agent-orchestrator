...
#
# ---knowledge---
# module_id: scripts.check-runaway-guard
# system: governance
# app: gates
# solution_class: enterprise
# patterns: [tri-state-exit, provoked-negative-control, no-false-green, offline-hermetic, named-refusal, bounded-work, lane-isolation]
# derives_from: null
# owner_sme: qa-sme
# tier: L1
