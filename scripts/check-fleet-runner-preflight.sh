...
#
# ---knowledge---
# module_id: scripts.check-fleet-runner-preflight
# system: governance
# app: gates
# solution_class: enterprise
# patterns: [tri-state-exit, provoked-negative-control, offline-hermetic, lane-isolation, schema-validation]
# derives_from: null
