...
#
# ---knowledge---
# module_id: scripts.check-chat-surface
# system: governance
# app: gates
# solution_class: enterprise
# patterns: [tri-state-exit, provoked-negative-control, no-false-green, offline-hermetic, feature-flag-gated-off, schema-validation]
# derives_from: null
# owner_sme: qa-sme
# tier: L1
