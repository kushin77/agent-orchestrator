...
#
# ---knowledge---
# module_id: scripts.check-reconcile
# system: governance
# app: gates
# solution_class: enterprise
# patterns: [tri-state-exit, provoked-negative-control, named-refusal, append-only, lane-isolation, deterministic, schema-validation]
# derives_from: null
