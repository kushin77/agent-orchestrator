...
#
# ---knowledge---
# module_id: scripts.check-control-functions
# system: governance
# app: gates
# solution_class: enterprise
# patterns: [tri-state-exit, provoked-negative-control, no-false-green, declared-authority, named-refusal, schema-validation]
# derives_from: null
# owner_sme: qa-sme
# tier: L1
