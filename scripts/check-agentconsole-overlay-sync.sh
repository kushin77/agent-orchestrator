...
#
# ---knowledge---
# module_id: scripts.check-agentconsole-overlay-sync
# system: governance
# app: gates
# solution_class: enterprise
# patterns: [tri-state-exit, provoked-negative-control, self-proving-gate, no-false-green, offline-hermetic, schema-validation]
# derives_from: null
# owner_sme: sync-sme
# tier: L1
