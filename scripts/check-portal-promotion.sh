...
#
# ---knowledge---
# module_id: scripts.check-portal-promotion
# system: governance
# app: gates
# solution_class: enterprise
# patterns: [tri-state-exit, provoked-negative-control, self-proving-gate, no-false-green, declared-authority, named-refusal, dry-run-default]
# derives_from: null
# owner_sme: qa-sme
# tier: L1
