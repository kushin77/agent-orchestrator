...
#
# ---knowledge---
# module_id: scripts.check-board-gate
# system: governance
# app: gates
# solution_class: enterprise
# patterns: [tri-state-exit, provoked-negative-control, no-false-green, offline-hermetic, lane-isolation]
# derives_from: null
# owner_sme: pmo-sme
# tier: L1
