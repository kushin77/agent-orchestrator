...
#
# ---knowledge---
# module_id: scripts.check-pr-queue-squash-guard
# system: governance
# app: gates
# solution_class: enterprise
# patterns: [tri-state-exit, provoked-negative-control, self-proving-gate, offline-hermetic, named-refusal, lane-isolation, deterministic]
# derives_from: null
# owner_sme: qa-sme
# tier: L1
