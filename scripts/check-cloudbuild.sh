...
#
# ---knowledge---
# module_id: scripts.check-cloudbuild
# system: governance
# app: gates
# solution_class: enterprise
# patterns: [tri-state-exit, no-false-green, offline-hermetic, declared-authority, named-refusal, feature-flag-gated-off, deterministic]
# derives_from: null
# owner_sme: iac-sme
# tier: L1
