...
#
# ---knowledge---
# module_id: scripts.check-python-lint
# system: governance
# app: gates
# solution_class: enterprise
# patterns: [tri-state-exit, provoked-negative-control, self-proving-gate, no-false-green, offline-hermetic, declared-authority, deterministic]
# derives_from: null
# owner_sme: qa-sme
# tier: L1
