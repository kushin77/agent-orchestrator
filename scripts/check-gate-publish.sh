...
#
# ---knowledge---
# module_id: scripts.check-gate-publish
# system: governance
# app: gates
# solution_class: enterprise
# patterns: [tri-state-exit, provoked-negative-control, dry-run-default, lane-isolation, schema-validation]
# derives_from: null
# owner_sme: qa-sme
# tier: L1
