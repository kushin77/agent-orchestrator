...
#
# ---knowledge---
# module_id: scripts.check-module-registry
# system: governance
# app: gates
# solution_class: enterprise
# patterns: [tri-state-exit, provoked-negative-control, no-false-green, offline-hermetic, append-only, lane-isolation, deterministic, schema-validation]
# derives_from: null
# owner_sme: qa-sme
# tier: L1
