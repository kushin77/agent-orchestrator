...
#
# ---knowledge---
# module_id: scripts.check-reap-branches
# system: governance
# app: gates
# solution_class: enterprise
# patterns: [tri-state-exit, provoked-negative-control, self-proving-gate, declared-authority, named-refusal, lane-isolation]
# derives_from: null
# owner_sme: qa-sme
# tier: L1
