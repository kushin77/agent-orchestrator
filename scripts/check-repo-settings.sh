...
#
# ---knowledge---
# module_id: scripts.check-repo-settings
# system: governance
# app: gates
# solution_class: enterprise
# patterns: [tri-state-exit, provoked-negative-control, no-false-green, offline-hermetic, declared-authority, deterministic]
# derives_from: null
