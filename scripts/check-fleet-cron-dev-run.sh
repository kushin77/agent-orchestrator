...
#
# ---knowledge---
# module_id: scripts.check-fleet-cron-dev-run
# system: governance
# app: gates
# solution_class: enterprise
# patterns: [tri-state-exit, provoked-negative-control, offline-hermetic, dry-run-default, feature-flag-gated-off, lane-isolation]
# derives_from: null
