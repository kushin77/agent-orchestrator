...
#
# ---knowledge---
# module_id: scripts.check-fleet-jobs
# system: governance
# app: gates
# solution_class: enterprise
# patterns: [tri-state-exit, provoked-negative-control, declared-authority, named-refusal, feature-flag-gated-off, lane-isolation, deterministic]
# derives_from: null
