...
| [`VENDOR-COMPLIANCE-GAP-132.md`](VENDOR-COMPLIANCE-GAP-132.md) | Vendor-compliance gap #132 (`kushin77/shared-services`) — the measured declaration, its owners, and why it must not be closed on its own gate (issue #132). |
