...
episode that produced it is recorded as `INC-0007` / `RCA-0007` in
...
| Incident | `INC-0007` — the tmpfs exhaustion and the silent 0-byte write |
| RCA | [`../governance/lessons/rca/RCA-0007-infra-limits-tmpfs-exhaustion.md`](../governance/lessons/rca/RCA-0007-infra-limits-tmpfs-exhaustion.md) |
| Corrective action | `CA-0009` — this guard and this contract |
| Learning | `SUGGEST-0005` — an infra limit is only a limit once a gate measures it |
