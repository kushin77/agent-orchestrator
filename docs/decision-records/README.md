...
| [ADR-0033](ADR-0033-bridge-consumer-contract.md) | The live-data bridge (`ao.bridge/v1`) is an external-API contract, not a console pane | accepted | issue #1523 (EPIC #1510) |
