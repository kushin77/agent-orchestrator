...
The exposition surface is owned by issue **#497** — the **push exporter**
(enabled by default, inert when unconfigured, AO-GR-6) over the telemetry feed. It renders the verdicts
