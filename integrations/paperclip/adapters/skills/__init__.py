...
* :mod:`~integrations.paperclip.adapters.skills.registry` — the **declared** skill registry.
...
* :mod:`~integrations.paperclip.adapters.skills.projection` — the MCP tool surface is
...
* :mod:`~integrations.paperclip.adapters.skills.loader` — the load gate. A skill or plugin
  ...
  stays the authority.
* :mod:`~integrations.paperclip.adapters.skills.frontmatter` — the ``SKILL.md`` loader. A
