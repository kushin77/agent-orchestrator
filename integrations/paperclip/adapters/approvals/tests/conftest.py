...
package path (``integrations.paperclip.adapters.approvals``) regardless of where pytest is
invoked.
"""
...
from integrations.paperclip.adapters.approvals import fixtures  # noqa: E402
