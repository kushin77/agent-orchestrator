...
from integrations.paperclip.adapters.approvals import fixtures, mapping, verify
from integrations.paperclip.adapters.approvals.model import STATE_GRANTED, STATE_PENDING, Approval
