...
from integrations.paperclip.adapters.approvals import fixtures, mapping
from integrations.paperclip.adapters.approvals.model import STATE_DENIED, STATE_GRANTED, STATE_PENDING
