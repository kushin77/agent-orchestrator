# Promotion audit record - `services.erp_webhooks_bridge` off -> canary
...
| audit log | `audit/promotion-audit.jsonl` seq 58, hash `6e9a3f421e07e6c621571661a002898a2994161487d165e8c2fcddac9e944323` |
...
```
promoted services.erp_webhooks_bridge off -> canary
```
