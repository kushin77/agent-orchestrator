# Promotion audit record - `services.web` gradual -> full
...
| actor | `deployer-sa` |
| approval | human approval_id `ao-20260925T203034Z-services-web-full` |
| verify_green | true |
| recorded_at | 2026-09-25T20:34:38Z |
| live-state | `live-state.yaml` |
| audit log | `audit/promotion-audit.jsonl` seq 36, hash `90ed01f4232462a6378f1a7fcde07d8b7bad17d2ad5ec5790490eb07d705d4e0` |
...
```
promoted services.web gradual -> full
```
