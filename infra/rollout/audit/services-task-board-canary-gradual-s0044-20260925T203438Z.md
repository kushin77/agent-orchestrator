# Promotion audit record - `services.task_board` canary -> gradual
...
| audit log | `audit/promotion-audit.jsonl` seq 44, hash `b145a5b997464345af1153d6fa3b4249470c1c47ec1144461062d760bc928a9c` |
...
```
promoted services.task_board canary -> gradual
```
