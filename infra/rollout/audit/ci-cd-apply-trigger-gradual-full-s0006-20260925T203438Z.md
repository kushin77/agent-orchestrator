# Promotion audit record - `ci_cd.apply_trigger` gradual -> full
...
| actor | `deployer-sa` |
| approval | human approval_id `ao-20260925T203034Z-ci_cd-apply_trigger-full` |
| verify_green | true |
| recorded_at | 2026-09-25T20:34:38Z |
| live-state | `live-state.yaml` |
| audit log | `audit/promotion-audit.jsonl` seq 6, hash `8b64eae7526a9a9b6143200ee123fcc4339c9b80af5dcc03cf67097b27bca33d` |
...
```
promoted ci_cd.apply_trigger gradual -> full
```
