# Promotion audit record - `services.erp_module` off -> canary
...
| audit log | `audit/promotion-audit.jsonl` seq 55, hash `f24378186bef72dd7997feef3b2a594ec778d08bf859ae3aba306b40484580fa` |
...
```
promoted services.erp_module off -> canary
```
