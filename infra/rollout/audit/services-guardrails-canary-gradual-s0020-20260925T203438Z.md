# Promotion audit record - `services.guardrails` canary -> gradual
...
| audit log | `audit/promotion-audit.jsonl` seq 20, hash `68e260eb04e2761a362b7f0156bcfe48b5b81bd5eea6378a11ea8a3b5da8e449` |
...
```
promoted services.guardrails canary -> gradual
```
