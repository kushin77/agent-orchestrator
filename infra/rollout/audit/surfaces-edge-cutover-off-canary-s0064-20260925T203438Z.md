# Promotion audit record - `surfaces.edge_cutover` off -> canary
...
| audit log | `audit/promotion-audit.jsonl` seq 64, hash `552d24ae960c4dfe2342204fc070846bc80d85ec91883e9f74b66986283a79ea` |
...
```
promoted surfaces.edge_cutover off -> canary
```
