# Promotion audit record - `services.task_board` gradual -> full
...
| field | value |
|---|---|
| flag | `services.task_board` |
| transition | `gradual` -> `full` |
| actor | `deployer-sa` |
| approval | human approval_id `ao-20260925T203034Z-services-task_board-full` |
| verify_green | true |
| recorded_at | 2026-09-25T20:34:38Z |
| live-state | `live-state.yaml` |
| audit log | `audit/promotion-audit.jsonl` seq 45, hash `56971d7381a895ffe94274975ccb95df69a13e988298382405c7ed62988168d1` |
...
```
promoted services.task_board gradual -> full
```
