# Promotion audit record - `services.registry` canary -> gradual
...
| audit log | `audit/promotion-audit.jsonl` seq 8, hash `248b3f90533cbc15c15af2f30e8af3823dbf9a144b5070d7decaa4a90eea30f3` |
...
```
promoted services.registry canary -> gradual
```
