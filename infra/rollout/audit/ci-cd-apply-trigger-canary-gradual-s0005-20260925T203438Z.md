# Promotion audit record - `ci_cd.apply_trigger` canary -> gradual
...
| audit log | `audit/promotion-audit.jsonl` seq 5, hash `1114586c0061f04da8fd40b63c7b9adafee08fd332b3bfc57c483083f9dd4903` |
...
```
promoted ci_cd.apply_trigger canary -> gradual
```
