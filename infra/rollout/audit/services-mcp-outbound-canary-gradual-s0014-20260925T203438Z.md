# Promotion audit record - `services.mcp_outbound` canary -> gradual
...
| audit log | `audit/promotion-audit.jsonl` seq 14, hash `4fd2ea986de1ec6f52c80bafd5182f2c4366243933317de3df51a37896c260cc` |
...
```
promoted services.mcp_outbound canary -> gradual
```
