# Promotion audit record - `surfaces.fleet_projection` off -> canary
...
| audit log | `audit/promotion-audit.jsonl` seq 46, hash `a085f74c1948628dca2dfc1e8ca995c6878bb3f739c43bbe0b53c63359654962` |
...
```
promoted surfaces.fleet_projection off -> canary
```
