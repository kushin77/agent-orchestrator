# Promotion audit record - `services.guardrails` off -> canary
...
| audit log | `audit/promotion-audit.jsonl` seq 19, hash `60f2ae9d313e32a3ed8f5c7812982c0d467d801b8f61083334327518dd26cfef` |
...
```
promoted services.guardrails off -> canary
```
