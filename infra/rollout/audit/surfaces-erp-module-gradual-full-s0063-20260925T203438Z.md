# Promotion audit record - `surfaces.erp_module` gradual -> full
...
| field | value |
|---|---|
| flag | `surfaces.erp_module` |
| transition | `gradual` -> `full` |
| actor | `deployer-sa` |
| approval | human approval_id `ao-20260925T203034Z-surfaces-erp_module-full` |
| verify_green | true |
| recorded_at | 2026-09-25T20:34:38Z |
| live-state | `live-state.yaml` |
| audit log | `audit/promotion-audit.jsonl` seq 63, hash `eabc7c5d0437929bb316b8eb2c844533446c753306732dcaee24c98c050506b7` |
...
```
promoted surfaces.erp_module gradual -> full
```
