# Promotion audit record - `services.sandbox_runtime` off -> canary
...
| audit log | `audit/promotion-audit.jsonl` seq 22, hash `e4c83a5fcad70a1a0a332459194f36bb3075b337fa7c49a6395df8832bd78a63` |
...
```
promoted services.sandbox_runtime off -> canary
```
