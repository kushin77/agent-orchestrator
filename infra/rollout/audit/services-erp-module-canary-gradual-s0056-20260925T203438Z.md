# Promotion audit record - `services.erp_module` canary -> gradual
...
| audit log | `audit/promotion-audit.jsonl` seq 56, hash `c61021872c7f3feb33c91fae88ddd13990ff8bdece9ab1992161af336bf6a16d` |
...
```
promoted services.erp_module canary -> gradual
```
