# Promotion audit record - `surfaces.erp_module` off -> canary
...
| audit log | `audit/promotion-audit.jsonl` seq 61, hash `72118a8f8e20e51b8f640b9126cec8e6e4119a6812a1aff639802fce82b6092c` |
...
```
promoted surfaces.erp_module off -> canary
```
