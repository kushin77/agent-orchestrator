# Promotion audit record - `services.engine` gradual -> full
...
| actor | `deployer-sa` |
| approval | human approval_id `ao-20260925T203034Z-services-engine-full` |
| verify_green | true |
| recorded_at | 2026-09-25T20:34:38Z |
| live-state | `live-state.yaml` |
| audit log | `audit/promotion-audit.jsonl` seq 18, hash `1f66c1cb5faabbf530d448cb0ce749331fed4edfaa5c8bfa09fb804d3f9fcd1d` |
...
```
promoted services.engine gradual -> full
```
