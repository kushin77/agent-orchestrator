# Promotion audit record - `services.identity` canary -> gradual
...
| audit log | `audit/promotion-audit.jsonl` seq 29, hash `796082858d77effe0591d7a520e03bdd71e6d9dcb180f9eeb1fbb4eaf5c4489e` |
...
```
promoted services.identity canary -> gradual
```
