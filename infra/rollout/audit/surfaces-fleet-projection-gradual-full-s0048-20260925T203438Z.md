# Promotion audit record - `surfaces.fleet_projection` gradual -> full
...
| actor | `deployer-sa` |
| approval | human approval_id `ao-20260925T203034Z-surfaces-fleet_projection-full` |
| verify_green | true |
| recorded_at | 2026-09-25T20:34:38Z |
| live-state | `live-state.yaml` |
| audit log | `audit/promotion-audit.jsonl` seq 48, hash `661f35b6eda14205d8d20fb61f47774512bcaf9e7c9be8ba137c911643078eb5` |
...
```
promoted surfaces.fleet_projection gradual -> full
```
