# Promotion audit record - `surfaces.remote_control` off -> canary
...
| audit log | `audit/promotion-audit.jsonl` seq 49, hash `8688338ce3d83fcd29800c02147cbb7b73fdb5b3bcdecc9078673459cbd78ee0` |
...
```
promoted surfaces.remote_control off -> canary
```
