# Promotion audit record - `surfaces.erp_module` canary -> gradual
...
| audit log | `audit/promotion-audit.jsonl` seq 62, hash `4f847e1a1caa593566a74cb0fcd6a45ade6b6b670d762ccca1c8de684a8860a4` |
...
```
promoted surfaces.erp_module canary -> gradual
```
