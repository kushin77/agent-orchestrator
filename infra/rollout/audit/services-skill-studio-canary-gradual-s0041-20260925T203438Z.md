# Promotion audit record - `services.skill_studio` canary -> gradual
...
| audit log | `audit/promotion-audit.jsonl` seq 41, hash `12f2d2c232be10e2936ce8d5228851380b8014efc15558efe6093d68ba33ce45` |
...
```
promoted services.skill_studio canary -> gradual
```
