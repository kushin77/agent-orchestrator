# Promotion audit record - `services.identity` off -> canary
...
| audit log | `audit/promotion-audit.jsonl` seq 28, hash `3561b19246446d1915952f1286dfba5b6ce063a7d9a0e63d2e8356dc9867b000` |
...
```
promoted services.identity off -> canary
```
