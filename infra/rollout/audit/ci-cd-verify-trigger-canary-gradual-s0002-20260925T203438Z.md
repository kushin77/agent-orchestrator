# Promotion audit record - `ci_cd.verify_trigger` canary -> gradual
...
| audit log | `audit/promotion-audit.jsonl` seq 2, hash `c67f10fb2531870906523c2b3e0d662e4e06d6950a51fbb8877233eb61249767` |
...
```
promoted ci_cd.verify_trigger canary -> gradual
```
