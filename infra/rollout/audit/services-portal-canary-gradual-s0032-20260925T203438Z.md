# Promotion audit record - `services.portal` canary -> gradual
...
| audit log | `audit/promotion-audit.jsonl` seq 32, hash `499acc5ce4be0390700635d194a3178f597462d231ace495cf38b585d6345c06` |
...
```
promoted services.portal canary -> gradual
```
