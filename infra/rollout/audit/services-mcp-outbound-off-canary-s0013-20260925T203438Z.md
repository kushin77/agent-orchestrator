# Promotion audit record - `services.mcp_outbound` off -> canary
...
| audit log | `audit/promotion-audit.jsonl` seq 13, hash `304df64aac8065b4870d27d804c9b9620775e434605a1f72f1774afd20b8e5df` |
...
```
promoted services.mcp_outbound off -> canary
```
