# Promotion audit record - `services.skill_studio` gradual -> full
...
| field | value |
|---|---|
| flag | `services.skill_studio` |
| transition | `gradual` -> `full` |
| actor | `deployer-sa` |
| approval | human approval_id `ao-20260925T203034Z-services-skill_studio-full` |
| verify_green | true |
| recorded_at | 2026-09-25T20:34:38Z |
| live-state | `live-state.yaml` |
| audit log | `audit/promotion-audit.jsonl` seq 42, hash `34e6ad29c9a71bcd53e2d1e693699df07b8bc11b820b2e0cff2105fd01caad85` |
...
```
promoted services.skill_studio gradual -> full
```
