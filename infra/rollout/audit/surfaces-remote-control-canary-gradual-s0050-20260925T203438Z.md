# Promotion audit record - `surfaces.remote_control` canary -> gradual
...
| audit log | `audit/promotion-audit.jsonl` seq 50, hash `fa0c1e1080a1c29d686000401c9991f722ac366f1d2e1e842883369ecf9a75f9` |
...
```
promoted surfaces.remote_control canary -> gradual
```
