# Promotion audit record - `surfaces.operator_terminal` canary -> gradual
...
| audit log | `audit/promotion-audit.jsonl` seq 53, hash `4caceed3f332e73eb73549723ba7316c585fb36aee602f627882afb549deb22b` |
...
```
promoted surfaces.operator_terminal canary -> gradual
```
