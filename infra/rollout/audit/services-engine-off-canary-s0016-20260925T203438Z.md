# Promotion audit record - `services.engine` off -> canary
...
| audit log | `audit/promotion-audit.jsonl` seq 16, hash `40a6b68ab0c2cd60a61b6595664b106fb162f168c8575e3d1a62da6b22c684fe` |
...
```
promoted services.engine off -> canary
```
