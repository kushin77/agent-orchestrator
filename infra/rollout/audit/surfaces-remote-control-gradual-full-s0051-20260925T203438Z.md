# Promotion audit record - `surfaces.remote_control` gradual -> full
...
| field | value |
|---|---|
| flag | `surfaces.remote_control` |
| transition | `gradual` -> `full` |
| actor | `deployer-sa` |
| approval | human approval_id `ao-20260925T203034Z-surfaces-remote_control-full` |
| verify_green | true |
| recorded_at | 2026-09-25T20:34:38Z |
| live-state | `live-state.yaml` |
| audit log | `audit/promotion-audit.jsonl` seq 51, hash `a6e459ae48cc516f0581ff84e58b9fa581183c381fd87caa689f389d521d80be` |
...
```
promoted surfaces.remote_control gradual -> full
```
