# Promotion audit record - `services.org_chart` canary -> gradual
...
| audit log | `audit/promotion-audit.jsonl` seq 38, hash `f345893627a47fa2441f46313b4ae7648011f703424cfc0caf39b41108641711` |
...
```
promoted services.org_chart canary -> gradual
```
