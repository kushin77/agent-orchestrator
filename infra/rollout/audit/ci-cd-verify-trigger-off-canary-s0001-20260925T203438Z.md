# Promotion audit record - `ci_cd.verify_trigger` off -> canary
...
| audit log | `audit/promotion-audit.jsonl` seq 1, hash `3f095007d84b02733220e87bd83db7f19b2807bb2300b25523b78cb214948623` |
...
```
promoted ci_cd.verify_trigger off -> canary
```
