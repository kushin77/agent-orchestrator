# Promotion audit record - `services.telemetry` canary -> gradual
...
| audit log | `audit/promotion-audit.jsonl` seq 26, hash `23b4325c2888829cdddab42241c20fa3a564f921ddc636cc295ccbff598c96d1` |
...
```
promoted services.telemetry canary -> gradual
```
