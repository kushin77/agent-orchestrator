# Promotion audit record - `services.gateway` off -> canary
...
| audit log | `audit/promotion-audit.jsonl` seq 10, hash `15b4519618ce810ffa7fe24a149fe1392a12c0ade171830795eedfbde6603617` |
...
```
promoted services.gateway off -> canary
```
