# Promotion audit record - `services.org_chart` gradual -> full
...
| field | value |
|---|---|
| flag | `services.org_chart` |
| transition | `gradual` -> `full` |
| actor | `deployer-sa` |
| approval | human approval_id `ao-20260925T203034Z-services-org_chart-full` |
| verify_green | true |
| recorded_at | 2026-09-25T20:34:38Z |
| live-state | `live-state.yaml` |
| audit log | `audit/promotion-audit.jsonl` seq 39, hash `8b69517474650aa6e87bc4bfebfb0c2fbde26bf8ece6f3f92bc6857630b9d988` |
...
```
promoted services.org_chart gradual -> full
```
