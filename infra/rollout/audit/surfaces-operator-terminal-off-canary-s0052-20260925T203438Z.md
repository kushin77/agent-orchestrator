# Promotion audit record - `surfaces.operator_terminal` off -> canary
...
| audit log | `audit/promotion-audit.jsonl` seq 52, hash `f89c546403c0a22d465ff3ae7202497558f8f01c02ad1f3b93815709d29d535b` |
...
```
promoted surfaces.operator_terminal off -> canary
```
