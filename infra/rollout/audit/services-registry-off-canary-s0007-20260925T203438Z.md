# Promotion audit record - `services.registry` off -> canary
...
| audit log | `audit/promotion-audit.jsonl` seq 7, hash `127133cf1aff3366c23cf23ad47a9c4842b809f4e1a053b07c3d14bea20461cd` |
...
```
promoted services.registry off -> canary
```
