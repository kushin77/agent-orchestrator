# Promotion audit record - `surfaces.operator_terminal` gradual -> full
...
| actor | `deployer-sa` |
| approval | human approval_id `ao-20260925T203034Z-surfaces-operator_terminal-full` |
| verify_green | true |
| recorded_at | 2026-09-25T20:34:38Z |
| live-state | `live-state.yaml` |
| audit log | `audit/promotion-audit.jsonl` seq 54, hash `01a06385455d1f21ff7a9b130c8f258dbbc35907eb975a99d3b58183f7ed9694` |
...
```
promoted surfaces.operator_terminal gradual -> full
```
