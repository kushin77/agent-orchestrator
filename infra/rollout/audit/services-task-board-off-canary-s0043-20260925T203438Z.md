# Promotion audit record - `services.task_board` off -> canary
...
| audit log | `audit/promotion-audit.jsonl` seq 43, hash `a53def17e00314df32e22076fca3f5d6016a8c465e9af698124eb45042bd6788` |
...
```
promoted services.task_board off -> canary
```
