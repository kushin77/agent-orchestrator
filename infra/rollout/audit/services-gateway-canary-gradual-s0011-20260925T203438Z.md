# Promotion audit record - `services.gateway` canary -> gradual
...
| audit log | `audit/promotion-audit.jsonl` seq 11, hash `f784ab6d0f8cb63d0e60b4c0e81b9e73060463101c1afa7815c35ef899f1ca79` |
...
```
promoted services.gateway canary -> gradual
```
