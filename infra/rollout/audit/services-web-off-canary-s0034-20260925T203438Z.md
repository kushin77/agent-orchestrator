# Promotion audit record - `services.web` off -> canary
...
| audit log | `audit/promotion-audit.jsonl` seq 34, hash `272a0c8845e208349c4671fbf57a15d8cf24a3a21a1b5e090790754d5db130d6` |
...
```
promoted services.web off -> canary
```
