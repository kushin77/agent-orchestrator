# Promotion audit record - `services.erp_webhooks_bridge` canary -> gradual
...
| audit log | `audit/promotion-audit.jsonl` seq 59, hash `21172e7460a0ddda1151f04972b2bc63a10a5ce40f73aff87862b9a775f3c94c` |
...
```
promoted services.erp_webhooks_bridge canary -> gradual
```
