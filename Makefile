...
.PHONY: help verify lint gate merge-gate qa-loop tests \
        ...
        issue-claims issue-template fleet-channel finops-chooser fleet-contract fleet-runbook session-isolation github-lifecycle reconcile knowledge-index knowledge-index-build paperclip-gap-analysis \
